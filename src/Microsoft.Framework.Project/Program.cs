...
namespace Microsoft.Framework.Project
{
    public class Program
    {
        ...
        {
            var app = new CommandLineApplication("Microsoft.Framework.Project", throwOnUnexpectedArg: false);
            app.HelpOptions("-h|--help", "-?");
            app.HelpCommand();
            app.Command("build", c =>
            {
                c.Description = "Build the project in current directory";
                ...
                c.OnExecute(() =>
                {
                    ...
                    buildOptions.ProjectDir = app.RemainingArguments.Any() ? app.RemainingArguments[0] : Directory.GetCurrentDirectory();
